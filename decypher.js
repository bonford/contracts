...
class Helpers {
  ...
  for (var contractObject in compiled.contracts){
      var bytecode = compiled.contracts[contractObject].bytecode
      console.log(bytecode)
      var abi = JSON.parse(compiled.contracts[contractObject].interface)
  }
